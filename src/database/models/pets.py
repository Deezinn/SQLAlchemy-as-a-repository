...
# from database.models.tratamentos import TratamentosModel
...
class PetsModel(Base):
    ...
    prontuario: Mapped["ProntuariosModel"] = relationship(
        back_populates="pet", uselist=False, cascade="all, delete-orphan"
    )

    tratamentos: Mapped[List["TratamentosModel"]] = relationship(
        secondary="pet_tratamentos", back_populates="pets"
    )
